        ...
        rows: [
            {
                ...
                cols: [
                    ...
                    {},
                    {
                        ...
                        autowidth: true,
                        click: function () {
                            agentmanage.admin.pageOrganize.add(function () {
                                reloadData();
                            });
                        }
                    },
                    {
                        ...
                        click: function () {
                            ...
                            console.log(item);
                            agentmanage.admin.pageOrganize.edit(item,function () {
                                reloadData();
                            });
                        }
                    },
                    {
                        ...
                        click: function () {
                            ...
                            agentmanage.admin.pageOrganize.agent.delete(item.code,function () {
                                reloadData();
                            })
                        }
                    }
...
// 增加
agentmanage.admin.pageOrganize.add = function(callback){
    var winid = "add";
    if ($$(winid)) {
        return;
    }
...
// 修改
agentmanage.admin.pageOrganize.edit = function(item,callback){
    var winid = "edit";
    if ($$(winid)) {
        return;
    }
...
// 删除
agentmanage.admin.pageOrganize.agent.delete = function (id,callback) {
    webix.confirm({
        title: "操作确认",
        ok: "是", cancel: "否",
        text: "确认要删除吗，此操作不可逆。",
